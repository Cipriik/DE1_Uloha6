...
REM
REM Generated by Vivado on Wed Apr 15 16:55:17 +0200 2026
...
echo "xvhdl --incr --relax -prj cfg_tb_digi_safe_vhdl.prj"
call xvhdl  --incr --relax -prj cfg_tb_digi_safe_vhdl.prj -log xvhdl.log
